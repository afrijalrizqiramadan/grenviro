                        ...
                        <div class="row flex-grow">
                            ...
                            ">{{ $status->status }}</label>
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="d-flex align-items-center justify-content-md-end">
                                                    <div class="pe-1 mb-3 mb-xl-0">
                                                        <button onclick="window.location.href='{{ route('delivery') }}'"
                    ...
                    <div class="col-sm-8 flex-column d-flex stretch-card">
                        <div class="row">
                            ...
                            <div class="col-lg-4 d-flex grid-margin stretch-card">
                                <div class="card sale-visit-statistics-border">
                                    <div class="card-body">
                                        <h2 class="text-dark mb-2 font-weight-bold">{{ $registration_date_device }}
                                        </h2>
                            ...
                            <div class="col-lg">
                                <row>
                                    <div class="card sale-visit-statistics-border">
                                        <div class="card-body">
                                            <h2 id="pressure-data" class="h2 mb-2 font-weight-bold">
                                                {{ $latestPressure }} bar</h2>
                                        ...
                                        "
                                            ...
                                            <small id="pressure-date"
                                                class="text-muted">{{ \Carbon\Carbon::parse($latestTime)->translatedFormat('d F Y H:i:s') }}</small>
                                        </div>
                                    </div>
                                    <br>
                                    <br>
                                ...
                                function fetchPressureData() {
                                    $.ajax({
                                        ...
                                        success: function(response) {
                                            $('#pressure-data').text(response.pressure + ' bar');
